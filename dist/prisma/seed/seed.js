...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.categoria.createMany({ data: categorias, skipDuplicates: true });
        ...
        yield prisma.producto.createMany({ data: productos, skipDuplicates: true });
        ...
        yield prisma.imagen.createMany({ data: imagenes, skipDuplicates: true });
        ...
        yield prisma.productoCategoria.createMany({ data: productoCategorias, skipDuplicates: true });
